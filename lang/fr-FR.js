...
export default {
  ...
  grtw__story: "Cette application permet d'enregistrer vos trajets quotidiens en bus pour ensuite vous afficher les temps de passages des bus direcetement sur votre écran d'acceuil.",
